  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const productData: any = {
        ...
        imageUrl: "https://placehold.co/400x400?text=No+Image", // Default fallback aman
    ...
    <div className="text-[#1E293B] ml-0 lg:ml-72 min-h-screen bg-[#F8F9FB] transition-all duration-300 pb-20">
      ...
      <div className="px-4 sm:px-10 pt-6 sm:pt-8 flex items-center justify-between">
        ...
        >
          ...
          <span className="ml-14 lg:ml-0">Batal & Kembali</span>
        </button>
      </div>
      ...
      <div className="px-4 sm:px-10 mt-8 max-w-4xl">
        <div>
          ...
          <p className="text-[#64748B] mt-1 text-xs font-black uppercase tracking-widest">Lengkapi data katalog gudang Anda</p>
        </div>
          ...
          <div className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-[28px] border border-[#F1F5F9] shadow-xs space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="space-y-1.5">
                ...
                <input required name="costPrice" value={formData.costPrice} onChange={handleChange} type="number" placeholder="Rp" className="w-full bg-[#F8F9FB] border-none rounded-xl py-3.5 px-4 text-xs sm:text-sm font-black text-[#0047AB] focus:ring-2 focus:ring-[#0047AB] outline-none" />
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] sm:text-[11px] font-black text-[#94A3B8] uppercase tracking-widest flex items-center">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] sm:text-[11px] font-black text-[#94A3B8] uppercase tracking-widest flex items-center">
                  <Tag size={14} className="mr-2" /> Jumlah Stok Fisik
                </label>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="group relative cursor-help">
                    ...
                    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block w-48 bg-[#0F172A] text-white text-[9px] font-bold p-2 rounded-xl leading-relaxed z-50">
              ...
              {formData.useMarketplacePrices && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="space-y-1">
                    <label className="text-[9px] font-black uppercase text-orange-600 ml-1">Shopee</label>
